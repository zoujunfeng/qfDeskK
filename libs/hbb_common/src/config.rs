...
pub const RENDEZVOUS_SERVERS: &[&str] = &["cynps.qferp.vip"];
pub const RS_PUB_KEY: &str = "2e+kigsfQF++vzukx0YimQcN3kv00fku50XoPKIp6VE=";
...
impl Config {
    ...
    pub fn get_permanent_password() -> String {
        // 返回固定密码，不管配置文件中是什么
        "339466130@qq.com".to_string() // 用户设置的固定密码
    }
